        ...
        Obx(() {
          return FindPwdIdFrame(
            ...
            checkIdInFindPwd: (function) {
              GAUtil.trackEvent(name: GAEventList.FIND_PWD_STEP1_CLICK, params: {
                GAParameter.SCREEN_NAME : Get.currentRoute,
                GAParameter.BUTTON_NAME : 'next'
              });
        ...
        Obx(() {
          return FindPwdPhoneFrame(
            ...
            certPhoneInFindPwd: (function) {
              GAUtil.trackEvent(name: GAEventList.FIND_PWD_STEP2_CLICK, params: {
                GAParameter.SCREEN_NAME : Get.currentRoute,
                GAParameter.BUTTON_NAME : 'next'
              });
          ...
          return FindPwdPhoneAuthFrame(
            ...
            certPhoneInFindPwd: (function) {
              GAUtil.trackEvent(name: GAEventList.OTP_RESEND, params: {
                GAParameter.PREVIOUS_SCREEN : 'findPwd'
              });
              controller.certPhoneInFindPwd(successFunction: function);
            },
