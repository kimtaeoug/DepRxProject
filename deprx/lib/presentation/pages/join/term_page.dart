...
class _TermPage extends State<TermPage> {
  ...
  @override
  void initState() {
    GAUtil.logScreen(screenName: GAScreenList.terms);
    super.initState();
          ...
          GestureDetector(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  isNecessary ? '${'terms_checkBox_condition_required'.tr} ${type.label}'  : '${'terms_checkBox_condition_optional'.tr} ${type.label}',
                  style: _labelStyle,
                ),
              ],
            ),
