...
class _AuthPage extends State<AuthPage> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
        ...
        onPopInvokedWithResult: (value, _){
          if(!value){
            Get.back(result: widget.isSocial == true ? false : true);
          }
        },
        child: Scaffold(
                      ...
                      children: [
                        ...
                        Obx(() {
                          return DPbutton(
                              ...
                              isEnabled: _controller.authPatientPassCondition());
                        })
                      ],
                    ),
                  ),
  ...
  void _process() {
    GAUtil.trackEvent(
        ...
        params: {GAParameter.INPUT_VALUE: _controller.authValue.value});
