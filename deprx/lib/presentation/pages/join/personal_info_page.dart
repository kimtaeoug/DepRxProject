  ...
  List<Widget> _frameList() => [
            ...
            certPhone: (text, function) {
              GAUtil.trackEvent(name: GAEventList.OTP_RESEND, params: {
                ...
                GAParameter.ATTEMP_COUNT:
                    _jController.certPhoneAttempCount.value
              });
              _jController.certPhone(text, function);
            },
            phoneValue: _jController.phone.value,
        ...
        Obx(() {
          return BirthDateFrame(
            moveFunction: (value) {
              GAUtil.trackEvent(
                  name: GAEventList.BIRTHDATE_SUBMIT,
                  params: {GAParameter.INPUT_VALUE: _jController.birth.value});
              _move(value);
            },
            isFromSummary: widget.isFromSummary ?? false,
        ...
        Obx(() {
          return AddressDetailFrame(
            moveFunction: (value) {
              GAUtil.trackEvent(name: GAEventList.ADDRESS_INPUT_SUBMIT, params: {
                GAParameter.INPUT_VALUE: _jController.address.value +
                    _jController.detailAddress.value
              });
              _move(value);
            },
            isFromSummary: widget.isFromSummary ?? false,
