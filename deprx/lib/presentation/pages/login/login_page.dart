...
class _EmailLoginPage extends State<LoginPage> {
  ...
  @override
  void initState() {
    GAUtil.logScreen(screenName: GAScreenList.login);
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (_idFocus.canRequestFocus && !_idFocus.hasFocus) {
                ...
                SliverToBoxAdapter(
                  child: Column(
                    ...
                    children: [
                      ...
                      DpJoinText(
                        function: () async {
                          GAUtil.trackEvent(name: GAEventList.SIGN_UP_CLICK);
        ...
        child: Row(
          ...
          children: [
            ...
            _findIdPWdItem('common_findId'.tr, () {
              GAUtil.trackEvent(name: GAEventList.FIND_ID_CLICK);
              UIUtil.closeKeyBoard();
            ...
            _findIdPWdItem('common_findPwd'.tr, () {
              GAUtil.trackEvent(name: GAEventList.FIND_PWD_CLICK);
              UIUtil.closeKeyBoard();
  ...
  void _backFunction() {
    if (Get.previousRoute == Routes.socialLogin) {
      UIUtil.closeKeyBoard();
      Get.back();
    } else {
      UIUtil.closeKeyBoard();
