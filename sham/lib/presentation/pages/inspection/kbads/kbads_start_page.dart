...
class _KBadsStartPage extends State<KBadsStartPage> {
  ...
  @override
  void initState() {
    GAUtil.logScreen(screenName: GAScreenList.kbadsIntro, isDeprx: false);
    SplashUtil.preWord();
                    ...
                    Padding(
                      ...
                      child: DPbutton(
                          ...
                          function: () async {
                            ...
                            await Get.toNamed(Routes.kBADSProgress);
                          }),
                    )
                  ],
                )
