  import 'package:common/common.dart';import 'package:flutter/cupertino.dart';
...
class _ReportOnboardingPage extends State<ReportOnboardingPage> {
  ...
  @override
  void initState() {
    GAUtil.logScreen(screenName: GAScreenList.reportOnboarding, isDeprx: false);
                                ...
                                function: () async {
                                  ...
                                  if (widget.reportData != null ||
                                    ...
                                    if (widget.reportData != null) {
                                      GAUtil.trackEvent(
                                          name:
                                          GAEventList.REPORT_ONBOARDING_COMPLETE, isDeprx: false);
                                      await Get.offNamed(Routes.reportDetailPage,
                                          arguments: {'data': widget.reportData});
                                    } else {
                                      await Get.offNamed(Routes.reportDetailPage);
                                    }
                                  } else {
