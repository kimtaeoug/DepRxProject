...
class _ProgramCompletePage extends State<ProgramCompletePage>
  ...
  @override
  void initState() {
    GAUtil.logScreen(screenName: GAScreenList.programComplete, isDeprx: false);
    super.initState();
  }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: DPbutton(
                      ...
                      function: () {
                        service.move();
                        // service.getProcedure(successFunction: (value) async {
                        //   await Get.offNamed(Routes.mainPage,
                        //       arguments: {'data': true});
                        // }, failFunction: () {
                        //   ToastHandler().show('errorMain_overview_subTitle'.tr, isError: true);
                        // });
                      }),
                )
              ],
