...
class _MyMemberShipPage extends State<MyMemberShipPage> {
        ...
        return MyPageItem(
            ...
            function: () {
              if (e == MyMembershipType.logout) {
                _dialog.showTitleWithSubtitle('logoutDialog_title'.tr, 'logoutDialog_subtitle'.tr, () {
                  _controller.logout();
                });
              } else {
                Get.toNamed(e.route);
  ...
  @override
  void initState(){
    GAUtil.logScreen(screenName: GAScreenList.myMembership, isDeprx: false);
    super.initState();
  }
        ...
        child: Obx(() {
          return Scaffold(
            ...
            body: Column(
              ...
              children: [
                TitleAppBar(title: 'common_userInfo'.tr),
                const SizedBox(
                  height: 20,
                ),
                MyPageItemContainer(
