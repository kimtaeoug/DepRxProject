...
class EmotionDiaryItem extends StatelessWidget {
  final DateTime dateTime;
  final String contents;

  EmotionDiaryItem({super.key, required this.dateTime, required this.contents});
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Text(
                  '${dateTime.month}/${dateTime.day} 감정 일기',
