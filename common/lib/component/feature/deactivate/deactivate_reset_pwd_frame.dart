...
import 'package:common/component/common/dp_text_input.dart';
import 'package:common/component/common/membership/obscure_button.dart';
...
class DeactivateResetPwdFrame extends StatefulWidget {
  ...
  final Function(String) checkNewPwdValid;
  ...
  @override
  State<StatefulWidget> createState() => _DeactivateResetPwdFrame();
}

class _DeactivateResetPwdFrame extends State<DeactivateResetPwdFrame> {
