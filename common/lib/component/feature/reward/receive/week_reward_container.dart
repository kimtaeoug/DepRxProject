...
class WeekRewardContainer extends StatelessWidget {
  RewardModel data;
  final int week;
            ...
            child: Column(
              children: [
                Expanded(
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${data.week}${'weeklyRewardReceive_header'.tr}',
                          style: _headerStyle,
                        ),
                        SizedBox(
                          width: 200,
                ...
                Padding(
                  ...
                  child: DPbutton(
                      text: week != 8 ? '$week${'weeklyRewardReceive_ctaBtn_report'.tr}' : 'common_ctaBtn_next'.tr,
