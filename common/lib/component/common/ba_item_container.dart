...
class BAItemContainer extends StatelessWidget {
  final BAModel data;
  final Function()? function;
  final bool needHead;

  BAItemContainer(
      {super.key, required this.data, this.function, this.needHead = false});
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child: DPNetworkImage(imgPath: data.imagePath, width: 50, height: 50, isCircle: false,),
        ),
        const SizedBox(
          width: 20,
        ),
